jQuery(document).ready(function($) {
    ...
    $('nav .main_menu li').addClass('menu-item');

    $('nav > ul.main_menu').attr('id', 'main_menu');

    $('nav #main_menu li.expanded').addClass('menu-item-has-children');

    for (var i = 1; i <= $('nav #main_menu > li').length; i++) {

        if ($('nav #main_menu > li:nth-child('+i+').mega-menu').text()) {

            var mega = $('nav #main_menu > li:nth-child('+i+').mega-menu > ul').html();

            mega = '<div class="sf-mega"><div class="sf-mega-inner clearfix"><ul>'+ mega + '</ul></div></div>';

            $('nav #main_menu > li:nth-child('+i+').mega-menu > ul').remove();

            $('nav #main_menu > li:nth-child('+i+').mega-menu').append(mega);
    ...
    $('#timeline_posts div.timeline_post:first-child').addClass('timeline_post_first');
    ...
    $("a.add_review_link").click(function(e){
            ...
            $("div.woocommerce-tabs > ul.dnd-tabs-ul > li.reviews_tab>a").click();
    ...
    $('.add_to_cart_ajax').click(function(e){
        ...
        var data = {
            ...
            action: 'ABdev_income_add_to_cart_wishlist',
    ...
    $('.search-icon').on('click', function(e) {
        ...
        if ($that.hasClass('active')) {
            ...
            $wrapper.find('input[type=text]').focus();
